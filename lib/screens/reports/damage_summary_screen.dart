...
class DamageSummaryScreen extends StatefulWidget {
  const DamageSummaryScreen({super.key});

  @override
  State<DamageSummaryScreen> createState() => _DamageSummaryScreenState();
}

class _DamageSummaryScreenState extends State<DamageSummaryScreen> {
