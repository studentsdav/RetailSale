          ...
          FilledButton(
            onPressed: () {
              setState(() {
                ...
                _customerName.text = nameCtrl.text.trim();
                _customerPhone.text = phoneCtrl.text.trim();
                _customerAddress.text = addressCtrl.text.trim();
                _customerGstin.text = gstCtrl.text.trim();
                _schemeManuallyRemoved = false;
                _refreshSelectedScheme();
              });
              _loadCustomerOutstanding();
