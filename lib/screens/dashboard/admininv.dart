...
class InventoryAdminDashboard extends StatefulWidget {
  const InventoryAdminDashboard({super.key});

  @override
  State<InventoryAdminDashboard> createState() =>
      _InventoryAdminDashboardState();
}

class _InventoryAdminDashboardState extends State<InventoryAdminDashboard> {
