              ...
              children: [
                pw.Expanded(
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(request.department ?? 'N/A', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 8.5, color: PdfColors.blueGrey900)),
                    ],
                  ),
                ),
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 4),
                    _metaRow("Request No", request.requestNo.toString()),
                    _metaRow("Date", DateFormat('dd-MMM-yyyy').format(request.requestDate)),
                    _metaRow("Status", request.status ?? 'Auto'),
                  ],
                ),
              ],
            ),
