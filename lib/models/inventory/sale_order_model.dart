...
class SaleOrder {
  ...
  SaleOrder copyWith({
    ...
    Map<String, dynamic>? paymentGatewayDetails,
    double? roundOffAmount,
    double? netAmount,
    String? voucherCode,
    String? voucherLabel,
    String? voucherFooterMessage,
    ...
    String? refundStatus,
    double? refundAmount,
    DateTime? refundPaidAt,
    String? refundPaymentMode,
    List<dynamic>? returnedItems,
    String? exchangeAgainstBillNo,
    bool? hasBillNo,
    int? orderId,
    List<SaleItem>? items,
    List<SaleScheme>? selectedSchemes,
    bool? affectStock,
    bool? itemsPreSplit,
    ...
    return SaleOrder(
      ...
      billingTaxMode: billingTaxMode ?? this.billingTaxMode,
      ...
      schemeUsageMode: schemeUsageMode ?? this.schemeUsageMode,
      ...
      paymentGatewayDetails: paymentGatewayDetails ?? this.paymentGatewayDetails,
      roundOffAmount: roundOffAmount ?? this.roundOffAmount,
      netAmount: netAmount ?? this.netAmount,
      voucherCode: voucherCode ?? this.voucherCode,
      voucherLabel: voucherLabel ?? this.voucherLabel,
      voucherFooterMessage: voucherFooterMessage ?? this.voucherFooterMessage,
      ...
      refundPaidAt: refundPaidAt ?? this.refundPaidAt,
      refundPaymentMode: refundPaymentMode ?? this.refundPaymentMode,
      returnedItems: returnedItems ?? this.returnedItems,
      exchangeAgainstBillNo: exchangeAgainstBillNo ?? this.exchangeAgainstBillNo,
      hasBillNo: hasBillNo ?? this.hasBillNo,
      orderId: orderId ?? this.orderId,
      items: items ?? this.items,
      selectedSchemes: selectedSchemes ?? this.selectedSchemes,
      affectStock: affectStock ?? this.affectStock,
      itemsPreSplit: itemsPreSplit ?? this.itemsPreSplit,
